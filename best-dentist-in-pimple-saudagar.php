...
$send = ['dr.sanamokashi@gmail.com', 'gobestdentist@gmail.com', 'seniormanager1234@gmail.com','branchpimplesaudagar@gmail.com',$branch];
$sendTo =  implode(',',$send);
...
try
{
    $emailText = "You have new message from Pimple Saudagar form website\n=============================\n";
...
<section class="root mt-0 pt-0">
    ...
    <div class="col-lg-8" style="text-align:center">
        <button class="btn btn-primary toggle1" style="background:#0704b4;">Book An Appointment</button>
