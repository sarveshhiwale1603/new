...
$sql=mysqli_query($conn,"UPDATE `contactus` SET `status`='$status',`remark`='$remark'  WHERE id='$id'");
                  ...
                  <table id="example2" class="table table-bordered table-striped dataTable" role="grid"
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="PO No.">First Name</th>
                        <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="PO No.">Last Name</th>
                    ...
                    <tbody>
                      <?php
											while($row = mysqli_fetch_array($contactus)) {
											?>
                      <tr role="row" class="odd">
                        ...
                        <td>
                          <a href="#m<?php echo $row['id'] ?>" class="btn btn-primary btn-rounded btn-icon contactm"
                            data-toggle="modal" data-target="#exampleModal" data-id='<?php echo $row['id']; ?>'
                            style="color: aliceblue"> <i class="fas fa-pen"></i>
                          </a>
                          <a class="btn btn-danger" href="contact_us.php?delid=<?php echo $row['id'];?>"><i
    ...
    <div class="modal-content">
      ...
      <form method="post">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="conupdate"class="btn btn-primary">Save changes</button>
        </div>
        <form>
    </div>
