...
$sql=mysqli_query($conn,"UPDATE `appointment` SET `status`='$status',`remark`='$remark'  WHERE id='$id'");
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid"
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="PO No.">Patient Name</th>
                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1">Phone Number
                        </th>
                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1">Branch</th>
                        <!--<th width="15%" class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"-->
                        <!--  aria-label="Action: activate to sort column ascending">Message</th>-->
                        <th width="15%" class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"
                          aria-label="Action: activate to sort column ascending">Date</th>
                        <th width="15%" class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"
                          aria-label="Action: activate to sort column ascending">Time</th>
                        <th width="15%" class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"
                    ...
                    <tbody>
                      ...
                      <tr role="row" class="odd">
                        ...
                        <td> <a href="#m<?php echo $row['id'] ?>"
                            class="btn btn-primary btn-rounded btn-icon usereditid" data-toggle="modal"
                            data-target="#exampleModal" data-id='<?php echo $row['id']; ?>' style="color: aliceblue"> <i
                              class="fas fa-pen"></i>
                          </a>
