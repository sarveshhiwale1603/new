...
if(isset($_POST['subm2'])){
    ...
    $location="admin/pages/forms/image/".$attachment;
...
//                      $uploadStatus = 0;
//                     $statusMsg = 'Sorry, File too large. File must be less than 500 kb';
//                 }else{
...
//                 // Recipient care@gobestdentist.com
//                 $send = ['dr.sanamokashi@gmail.com', 'gobestdentist@gmail.com', 'seniormanager1234@gmail.com','care@gobestdentist.com'];
// $toEmail =  implode(',',$send);


//                 // Sender
//                 $from = $email;
//                 $fromName = 'Gobest Dentist';
                
//                 // Subject
//                 $emailSubject = 'Career Request Submitted by '.$name;
                
//                 // Message 
//                 $htmlContent = '<h2>Career Request Submitted</h2>
//                     <p><b>Name:</b> '.$name.'</p>
//                     <p><b>Email:</b> '.$email.'</p>
...
$sql=mysqli_query($conn,"INSERT INTO `carrers`(`name`, `email`, `phone`, `message`, `resume`) VALUES ('$name','$email','$phone','$message','$attachment')");
if($sql)
			{
...
<?php } ?>
                <form  method="post" enctype="multipart/form-data" id="form1" name="form1" class="mb-3 form-label" autocomplete="off" >
                  <fieldset>
                <div class="border">
                    <div class="mb-3">
                        <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="input-container">
                        <div class="validateField">
                           <input type="text" name="phone" style="border-radius:10px; border:none; padding:15px;" class="wpcf7-form-control-wrap phone_number" value="<?php echo !empty($postData['subject'])?$postData['subject']:''; ?>" placeholder="Phone*" id="phone" required="">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <div class="input-container">
                        <div class="validateField ">
                            ...
                            <p style="font-size:14px;margin-top:8px;margin-left:7px">Only pdf extension files upto 500kb are allowed.</p>
                        </div>
                    </div>
                </div> 
                 <div class="mb-3">
                    <div class="mb-3 ">
                        <div class="validateField contact-form-label">
                            ...
                            <input type="file" name="attachment" class="contact-form-label btn " accept=".pdf">
                        </div>
                    </div>
                </div> 
                 
               
                <div class="button-row contact-form-label mb-3"> <input type="submit" class=" btn btn-primary wpcf7-form-control has-spinner wpcf7-submit" name="subm2" class="btn" value="SUBMIT"></div>
    </fieldset>
            </form>
