...
<body>
    ...
    <form  method="post" action="formaction.php" id="bookForm">
      ...
      <input type="text" name="PhoneNumber" class="sideinputphone" minlength="10" maxlength="10" placeholder="Phone Number" required>
   ...
   <input type="submit" name="submit" class="subside" value="Make Your Appointment" onclick="fun()" required >
    </form>
    </div>
  </div>
